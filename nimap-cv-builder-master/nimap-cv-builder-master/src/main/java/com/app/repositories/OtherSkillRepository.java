...
public interface OtherSkillRepository extends JpaRepository<OtherSkillMasterEntity, Long> {
	...
	Optional<OtherSkillMasterEntity> findByIdAndIsActiveTrue(Long id);
	...
	Optional<OtherSkillMasterEntity> findByNameContainingIgnoreCase(String name);
}
