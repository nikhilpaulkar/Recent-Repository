...
public interface ToolRepository extends JpaRepository<ToolsMasterEntity, Long> {
	...
	Optional<ToolsMasterEntity> findByIdAndIsActiveTrue(Long id);

	ArrayList<MasterListDto> findByIdIn(ArrayList<Long> toolId, Class<MasterListDto> MasterListDto);

	List<MasterListDto> findByIsActiveTrue(Class<MasterListDto> MasterListDto);

	Optional<ToolsMasterEntity> findByNameContainingIgnoreCase(String name);
}
