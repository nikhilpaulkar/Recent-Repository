...
public interface FrameworkRepository extends JpaRepository<FrameworkMasterEntity, Long> {
	...
	Optional<FrameworkMasterEntity> findByIdAndIsActiveTrue(Long id);
	...
	Optional<FrameworkMasterEntity> findByNameContainingIgnoreCase(String name);
}
