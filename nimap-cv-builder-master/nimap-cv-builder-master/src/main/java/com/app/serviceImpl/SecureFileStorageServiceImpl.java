...
@Service("secureFileStorageServiceImpl")
public class SecureFileStorageServiceImpl implements SecureFileStorageServiceInterface {

	private final Path fileStorageLocation;

	@Autowired
	public SecureFileStorageServiceImpl(SecureFileStorageProperties fileStorageProperties) {
